...
<style>
    ...
    .stMarkdown, p, label, [data-testid="stCaptionContainer"], [data-testid="stText"] {
        color: #111827;
    }
    #MainMenu,
    header,
    ...
    .section-header p { color: #334155; margin: 0.25rem 0 0; font-size: 0.93rem; font-weight: 500; }
    .output-hero {
    ...
    .output-hero .oh-label { font-size: 0.74rem; text-transform: uppercase; letter-spacing: 0.15em; color: rgba(255,255,255,0.82); }
    .output-hero .oh-value { font-size: 2.1rem; font-weight: 800; margin-top: 0.1rem; }
    .output-hero .oh-sub { font-size: 0.87rem; color: rgba(255,255,255,0.88); margin-top: 0.15rem; }
    ...
    .kpi-subtitle { color: #334155; font-size: 0.92rem; margin-top: 0.18rem; }
